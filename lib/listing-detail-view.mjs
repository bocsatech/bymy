...
export function buildListingDetailView(listing = {}) {
  ...
  const bodyTech = [
    kv("CO₂-kibocsátás", str(form, "co2_kibocsatas") ? `${str(form, "co2_kibocsatas")} g/km` : ""),
    ...
    kv("Környezetvédelmi osztály", str(form, "kornyezetvedelmi")),
