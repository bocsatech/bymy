...
import { createAdForm } from "./form-core.js?v=deskSidebarTrim15";
...
import { applyAdFormDesk, clearAdFormEditBoot, isDeskVehicleSubtype } from "./ad-form-desk.js?v=extrasToggle1";
import {
  requireAuthForPage,
  getAuthUser,
  loginUrl,
