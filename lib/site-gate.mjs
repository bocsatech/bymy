 ...
 * Kikapcsolás (minden nyilvános): SITE_PUBLIC=1
 *
 * Alapból a piactér böngészése nyilvános; fiók / üzenetek / feladás továbbra is belépéshez kötött.
 */
...
export function isPublicApiPath(pathname, method = "GET") {
  ...
  // Hirdetéslista / részlet olvasás — írás és /mine továbbra is auth a handlerben
