...
import { createAdForm } from "./form-core.js?v=appearanceBm2";
...
import { applyAdFormDesk, clearAdFormEditBoot, isDeskVehicleSubtype } from "./ad-form-desk.js?v=adFormDesk37";
import {
  requireAuthForPage,
  getAuthUser,
  loginUrl,
