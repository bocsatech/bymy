...
export async function listListingsWithPreview({ limit = 50, status = null, vertical = null } = {}) {
  ...
  // Egyszer töltjük a cellákat (listListings cell_count-ja nélkül), lapozva — különben
  // a PostgREST 1000-es limit üres árat/km-t ad a mozaikon, miközben a detail OK.
