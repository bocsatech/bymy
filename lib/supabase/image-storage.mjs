...
export async function uploadOptimizedImage({
  ...
  const { isFilesystemImageStorage, uploadOptimizedImageToFilesystem } = await import(
    "../filesystem-image-storage.mjs"
  );
  ...
  return {
    bucket: finalBucket,
    path: finalFileName,
    publicUrl: rewritePublicStorageUrl(data?.publicUrl ?? null),
