...
/** Admin: üzletági és ingatlantípus-sémák — külön mentés, másolat a masterről. */
...
export const INGATLAN_WHEEL_FIELD_DEFS = [
  ...
  { field_key: "telekterulet", label: "Telekterület", kind: "wheel", surfaces: ["post"] },
  ...
  { field_key: "szintek", label: "Szintek száma", kind: "wheel", surfaces: ["post"] },
  ...
  { field_key: "uzemeltetesi_dij", label: "Üzemeltetési díj", kind: "wheel", surfaces: ["post"] },
  ...
  { field_key: "epitmeny_terulet", label: "Építmény terület", kind: "wheel", surfaces: ["post"] },
