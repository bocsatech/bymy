...
export function buildListingDetailView(listing = {}) {
  ...
  const categoryHref =
    vertical === "teher" ? "/teherauto.html" : vertical === "ingatlan" ? "/ingatlan.html" : "/auto.html";
  const categoryLabel =
    vertical === "teher" ? "Teherautó" : vertical === "ingatlan" ? "Ingatlan" : "Autó";
  ...
  let marketHint = null;
  if (vertical !== "ingatlan" && marketDataAvailable()) {
    try {
