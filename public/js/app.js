...
import { createAdForm } from "./form-core.js?v=photoAutoUpload1";
...
import { applyAdFormDesk, clearAdFormEditBoot, isDeskVehicleSubtype } from "./ad-form-desk.js?v=adFormDesk35";
import {
  requireAuthForPage,
  getAuthUser,
  loginUrl,
