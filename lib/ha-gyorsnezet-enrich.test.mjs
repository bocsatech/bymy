...
test("extractFelszereltsegFromHtml: extranev és inline lista", () => {
  const html = `
    <div><strong>Beltér</strong><ul><li class="extranev">tempomat</li><li class="extranev">fedélzeti komputer</li></ul></div>
    <span class="extranev">tolatókamera</span>
    <div class="felszereltseg-block"><strong>Műszaki</strong> · ABS (blokkolásgátló) · ESP (menetstabilizátor)</div>
  `;
  const items = extractFelszereltsegFromHtml(html);
