...
export function ingatlanWheelSchemaKvKey(variant) {
  switch (normalizeIngatlanWheelVariant(variant)) {
    ...
    default:
      if (INGATLAN_TIPUS_LAYOUTS.includes(normalizeIngatlanWheelVariant(variant))) {
        return `${normalizeIngatlanWheelVariant(variant)}_wheel_schema_v1`;
      }
...
export const INGATLAN_WHEEL_FIELD_DEFS = [
  ...
  { field_key: "alapterulet", label: "Alapterület", kind: "number", unit: "m²", step: "1", surfaces: ["post"] },
  ...
  { field_key: "telekterulet", label: "Telekterület", kind: "number", unit: "m²", step: "1", surfaces: ["post"] },
  ...
  { field_key: "szintek", label: "Szintek száma", kind: "number", step: "1", surfaces: ["post"] },
  ...
  { field_key: "uzemeltetesi_dij", label: "Üzemeltetési díj", kind: "number", unit: "Ft", step: "1", surfaces: ["post"] },
  ...
  { field_key: "epitmeny_terulet", label: "Építmény terület", kind: "number", unit: "m²", step: "1", surfaces: ["post"] },
  ...
  { field_key: "energiahatekonys", label: "Energetikai tanúsítvány", kind: "wheel", surfaces: ["search", "post"] },
  ...
  { field_key: "nincs_gaz_bekotve", label: "Nincs gáz bekötve", kind: "wheel", surfaces: ["post"] },
  { field_key: "napelem_kw", label: "Napelem teljesítmény", kind: "number", unit: "kW", surfaces: ["post"], step: "0.1" },
  { field_key: "szigeteles_cm", label: "Szigetelés vastagság", kind: "number", unit: "cm", surfaces: ["post"], step: "1" },
...
function defaultPlacementRaw() {
  return [
    ...
    { field_key: "alapterulet", section: "main", row: 3, col: 1, colSpan: 12, hidden: false },
    { field_key: "telekterulet", section: "main", row: 4, col: 1, colSpan: 12, hidden: false },
    ...
    { field_key: "atlagos_gaz_fogyasztas", section: "more", row: 2, col: 7, colSpan: 6, hidden: false },
    { field_key: "nincs_gaz_bekotve", section: "more", row: 3, col: 1, colSpan: 6, hidden: false },
    { field_key: "futes", section: "more", row: 3, col: 7, colSpan: 6, hidden: false },
    { field_key: "energiahatekonys", section: "more", row: 4, col: 1, colSpan: 6, hidden: false },
    { field_key: "rezsikoltseg", section: "more", row: 4, col: 7, colSpan: 6, hidden: false },
    { field_key: "kozos_koltseg", section: "more", row: 5, col: 1, colSpan: 6, hidden: false },
    { field_key: "napelem", section: "more", row: 5, col: 7, colSpan: 6, hidden: false },
    { field_key: "napelem_kw", section: "more", row: 6, col: 1, colSpan: 6, hidden: false },
    { field_key: "szigeteles", section: "more", row: 6, col: 7, colSpan: 6, hidden: false },
    { field_key: "szigeteles_cm", section: "more", row: 7, col: 1, colSpan: 6, hidden: false },
    { field_key: "min_berleti_ido", section: "more", row: 7, col: 7, colSpan: 6, hidden: false },
    { field_key: "butorozott", section: "more", row: 8, col: 1, colSpan: 6, hidden: false },
    { field_key: "kilatas", section: "more", row: 8, col: 7, colSpan: 6, hidden: false },
    { field_key: "tajolas", section: "more", row: 9, col: 1, colSpan: 6, hidden: false },
    { field_key: "parkolas", section: "more", row: 9, col: 7, colSpan: 6, hidden: false },
    { field_key: "komfort", section: "more", row: 10, col: 1, colSpan: 6, hidden: false },
    { field_key: "tetoter", section: "more", row: 10, col: 7, colSpan: 6, hidden: false },
    { field_key: "furdo_wc", section: "more", row: 11, col: 1, colSpan: 6, hidden: false },
    { field_key: "emelet_tol", section: "more", row: 12, col: 1, colSpan: 6, hidden: false },
    { field_key: "emelet_ig", section: "more", row: 12, col: 7, colSpan: 6, hidden: false },
    { field_key: "emelet", section: "more", row: 13, col: 1, colSpan: 6, hidden: false },
    { field_key: "belmagassag", section: "more", row: 13, col: 7, colSpan: 6, hidden: false },
    { field_key: "koltozheto", section: "more", row: 14, col: 1, colSpan: 6, hidden: false },
    { field_key: "lift", section: "more", row: 14, col: 7, colSpan: 3, hidden: false },
    { field_key: "erkely", section: "more", row: 14, col: 10, colSpan: 3, hidden: false },
    { field_key: "akadalymentesitett", section: "more", row: 15, col: 1, colSpan: 3, hidden: false },
    { field_key: "legkondicionalo", section: "more", row: 15, col: 4, colSpan: 3, hidden: false },
    { field_key: "kertkapcsolatos", section: "more", row: 15, col: 7, colSpan: 3, hidden: false },
    { field_key: "panelprogram", section: "more", row: 15, col: 10, colSpan: 3, hidden: false },
    { field_key: "gepesitett", section: "more", row: 16, col: 1, colSpan: 3, hidden: false },
    { field_key: "kisallat_megengedett", section: "more", row: 16, col: 4, colSpan: 3, hidden: false },
    { field_key: "dohanyzas_megengedett", section: "more", row: 16, col: 7, colSpan: 3, hidden: false },
    { field_key: "pince", section: "more", row: 16, col: 10, colSpan: 3, hidden: false },
    { field_key: "uj_parcellazasu", section: "more", row: 17, col: 1, colSpan: 3, hidden: false },
    { field_key: "villany", section: "more", row: 17, col: 4, colSpan: 3, hidden: false },
    { field_key: "viz", section: "more", row: 17, col: 7, colSpan: 3, hidden: false },
    { field_key: "gaz", section: "more", row: 17, col: 10, colSpan: 3, hidden: false },
    { field_key: "csatorna", section: "more", row: 18, col: 1, colSpan: 3, hidden: false },
    { field_key: "irodahaz_kategoria", section: "more", row: 18, col: 4, colSpan: 5, hidden: false },
    { field_key: "kaucio_max", section: "more", row: 18, col: 9, colSpan: 4, hidden: false },
    { field_key: "szintek_tol", section: "more", row: 19, col: 1, colSpan: 6, hidden: false },
    { field_key: "szintek_ig", section: "more", row: 19, col: 7, colSpan: 6, hidden: false },
    { field_key: "szintek", section: "more", row: 19, col: 1, colSpan: 12, hidden: false },
    { field_key: "uzemeltetesi_dij_tol", section: "more", row: 20, col: 1, colSpan: 6, hidden: false },
    { field_key: "uzemeltetesi_dij_ig", section: "more", row: 20, col: 7, colSpan: 6, hidden: false },
    { field_key: "uzemeltetesi_dij", section: "more", row: 20, col: 1, colSpan: 12, hidden: false },
    { field_key: "epitmeny_terulet_tol", section: "more", row: 21, col: 1, colSpan: 6, hidden: false },
    { field_key: "epitmeny_terulet_ig", section: "more", row: 21, col: 7, colSpan: 6, hidden: false },
    { field_key: "epitmeny_terulet", section: "more", row: 21, col: 1, colSpan: 12, hidden: false },
    { field_key: "ar_ft_min", section: "more", row: 22, col: 10, colSpan: 3, hidden: true },
  ];
}
