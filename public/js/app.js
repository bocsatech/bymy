...
import { createAdForm } from "./form-core.js?v=egyebInfoFix1";
...
import { applyAdFormDesk, clearAdFormEditBoot, isDeskVehicleSubtype } from "./ad-form-desk.js?v=adFormDesk42";
import {
  requireAuthForPage,
  getAuthUser,
  loginUrl,
