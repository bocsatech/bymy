...
const PAGE_DEFAULT_TITLES = {
  ...
  ajanlasok: { left: "Ajánló tippek", right: "Ajánló videók" },
  kereses: { left: "Keresés tippek", right: "Keresés videók" },
  uzenetek: { left: "Üzenetek", right: "Segítség" },
  fiok: { left: "Fiók tippek", right: "Fiók videók" },
  beallitasok: { left: "Beállítás tippek", right: "Beállítás videók" },
  partners: { left: "Partner tippek", right: "Partner videók" },
  hirdetes: { left: "Hirdetés tippek", right: "Hirdetés videók" },
};
