...
import { createAdForm } from "./form-core.js?v=deskAccScroll1";
...
import { applyAdFormDesk, clearAdFormEditBoot, isDeskVehicleSubtype } from "./ad-form-desk.js?v=adFormDesk40";
import {
  requireAuthForPage,
  getAuthUser,
  loginUrl,
