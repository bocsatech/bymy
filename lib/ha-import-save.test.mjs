...
test("validateReadyToSave elutasítja az üres ID-stubot", () => {
  const msg = validateReadyToSave(
    { visibleTitle: "Hirdetés 23429942", listingId: "23429942", map: {} },
    { hirdetes_cime: "Hirdetés 23429942", hasznaltauto_hirdetes_id: "23429942" }
  );
  assert.match(String(msg), /kiolvasni/i);
});
