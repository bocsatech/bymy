...
export function isPublicApiPath(pathname, method = "GET") {
  ...
  if (pathname === "/api/visit" && m === "POST") return true;
  ...
  if (pathname === "/api/ad-form-desk-guide" && m === "GET") return true;
  ...
  if (pathname === "/api/import/extracted" && (m === "POST" || m === "OPTIONS")) return true;
  ...
  if (/^\/api\/listings\/\d+\/related$/.test(pathname) && m === "GET") return true;
  if (/^\/api\/listings\/\d+\/reveal-contact$/.test(pathname) && m === "POST") return true;
  if (/^\/api\/listings\/\d+\/seller-contact$/.test(pathname) && m === "GET") return true;
  if (/^\/api\/listings\/\d+\/seller-rating$/.test(pathname) && m === "GET") return true;
