  ...
  const data = {
    ...
    gyartmany: normalizeBrand(
      sanitizeListingFieldValue(
        String(
          pickValue(m, ["gyártmány", "gyartmany", "márka", "marka"]) || titleParts.gyartmany || ""
        )
      )
    ),
    modell: sanitizeListingFieldValue(pickValue(m, ["modell", "típusjel", "tipusjel"]) || titleParts.modell),
